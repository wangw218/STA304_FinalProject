...
The plot [Figure \@ref(fig:surveydata)] shows the number of supporters of each Party in survey Data. From the plot, we could see Liberal Party and Conservative Party have the most number of supporters while the number of supporters of Liberal Party is slightly larger than Conservative Party's. There are a lot of people Don't know or prefer not to answer which part they would like to vote and many NA data.
